...
This page provides an overview of the primary **LoRaWAN** components.
...
* Visit: [https://en.wikipedia.org/wiki/LoRa#LoRaWAN](https://en.wikipedia.org/wiki/LoRa#LoRaWAN)
